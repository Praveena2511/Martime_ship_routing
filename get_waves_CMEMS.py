...
motu_path = r'C:\Users\praveena\New folder (2)\Lib\site-packages\motuclient.py'
user     = ' -u pm4'
passwd   = ' -p Pravkarish#251'
...
if wave_prod==6:
    ### BALTIC SEA
    CMEMS_service = ' --service-id	BALTICSEA_ANALYSISFORECAST_WAV_003_006-TDS'
